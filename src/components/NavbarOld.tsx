...
const Navbar = () => {
    ...
    return (
        <>
            <nav className='flex fixed top-0 left-0 w-full lg:justify-around justify-between shadow-sm px-3 py-2 lg:py-3 lg:px-0 items-center bg-white z-[100]'>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className='fixed left-0 top-[72px] h-[calc(100vh-72px)] w-full lg:hidden bg-black'
                        >
                            <motion.ul
