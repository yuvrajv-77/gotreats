...
const TermsConditions = () => {
    return (
        <div>
            <div className='bg-orange-500 text-center mt-10 py-10 px-5'>
                <h1 className=' lancelot text-5xl text-white'>Terms and Conditions</h1>
            </div>
            <div className='container mx-5 md:mx-auto flex flex-col justify-center gap-5 flex-wrap text-sm py-5 md:px-20'>
                <p>
